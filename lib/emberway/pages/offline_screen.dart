...
class OfflineCrest extends StatefulWidget {
  const OfflineCrest({
    super.key,
    required this.watch,
  ...
  @override
  State<OfflineCrest> createState() => _OfflineCrestState();
}

class _OfflineCrestState extends State<OfflineCrest> {
  ...
  void initState() {
    ...
    // BootScreen locks portrait right before routing here; re-enable landscape
    // so the offline artwork rotates.
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          gradient: const LinearGradient(
            colors: <Color>[Color(0xFFFFC24A), Color(0xFFD8380B)],
                  ...
                  : const Row(
                      ...
                      children: <Widget>[
                        Icon(Icons.refresh_rounded,
                            color: Color(0xFF3A1608), size: 28),
                        SizedBox(width: 10),
                        Text(
                          'Retry',
                          style: TextStyle(
