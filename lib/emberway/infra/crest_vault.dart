...
/// Persistence for the gray flow: route decision, cached/pending URLs, push
/// permission flags and the push-invite snooze. Key prefix `emb.gate.*` is
/// unique to this app.
class CrestVault {
  static const String _routeKey = 'emb.gate.route';
  static const String _expiryKey = 'emb.gate.expiry';
  static const String _inviteKey = 'emb.gate.invite.after';
  static const String _permissionKey = 'emb.gate.push.allowed';
  static const String _osDeniedKey = 'emb.gate.push.os_denied';
  static const String _savedUrlKey = 'emb.gate.secure.destination';
  static const String _pendingUrlKey = 'emb.gate.secure.pending';
  ...
  CrestRoute get route => CrestRoute.parse(_preferences.getString(_routeKey));

  Future<void> saveRoute(CrestRoute route) =>
